...
pub struct DomainServices {
    ...
    pub models_service: Arc<dyn services::models::ModelsServiceTrait>,
...
/// Initialize domain services with a provided inference provider pool and models service
/// This function is only available when running tests (integration or unit tests)
#[cfg(any(test, feature = "test-support"))]
pub async fn init_domain_services_with_pool_and_models(
    database: Arc<Database>,
    config: &ApiConfig,
    organization_service: Arc<dyn services::organization::OrganizationServiceTrait + Send + Sync>,
    inference_provider_pool: Arc<services::inference_provider_pool::InferenceProviderPool>,
